...
declare class gdProjectResourcesCopier {
  ...
  static copyObjectResourcesTo(project: gdProject, originalObject: gdObject, fs: gdAbstractFileSystem, destinationDirectory: string, updateOriginalObject: boolean, preserveDirectoryStructure: boolean): boolean;
  delete(): void;
  ptr: number;
};